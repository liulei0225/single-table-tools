...
//            Writer writer = new FileWriter(file);
    ...
    private static String header = " * @desctiption   This file is generated by JadeFortune code generation tool version 0.2 ^_^\r\n * @Created   " + dateFormat.format(new Date());
    ...
    private static String format(String content, String project, String pkgDir, String bo) throws Exception {
        ...
        if (bo != null) {
            ...
            map.put("lowerBo", Util.lowerAll(bo));
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Table table : tables) {
        	 ...
        	 * 从table配置中获取外键
        	 */
//        	Map<String, com.qieren.tool.core.Config.Table> a= Config.instance().getTables();//gg
//        	Config.Table configTable = Config.instance().getTables().get(table.getTableName());//gg
//        	if(null!=configTable.getFk()&&("").equals(configTable.getFk())){
//        	table.setFk(configTable.getFk());             //gg
//        	}
