...
public class Column {
	...
	public String toString() {
		return "Column [table=" + table + ", columnName=" + columnName
				+ ", property=" + property + ", pk=" + pk + ", fkColumn="
				+ fkColumn + ", dataTypeName=" + dataTypeName + ", dataType="
				+ dataType + ", remark=" + remark + ", displayName="
				+ displayName + ", inputType=" + inputType + ", typeClass="
				+ typeClass + ", columnSize=" + columnSize + ", decimalDigits="
				+ decimalDigits + ", nullAble=" + nullAble + ", geneType="
				+ geneType + ", colSpan=" + colSpan + ", query=" + query
				+ ", listShow=" + listShow + ", emptyText=" + emptyText
				+ ", order=" + order + ", fkTableColumn=" + fkTableColumn
				+ ", extProp=" + extProp + "]";
	}
